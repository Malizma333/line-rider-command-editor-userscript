...
export const DOWNLOAD: InlineIcon = {
  dangerouslySetInnerHTML: {
...
export const UPLOAD: InlineIcon = {
  dangerouslySetInnerHTML: {
...
export const SETTINGS: InlineIcon = {
  dangerouslySetInnerHTML: {
...
export const MINIMIZE: InlineIcon = {
  dangerouslySetInnerHTML: {
...
export const MAXIMIZE: InlineIcon = {
  dangerouslySetInnerHTML: {
